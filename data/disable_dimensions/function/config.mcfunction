...
tellraw @s ["",{color:"#ffaa00",text:"World Spawn: "},{color:"aqua",nbt:"world_spawn.x",storage:"disable_dimensions:config"}," ",{color:"aqua",nbt:"world_spawn.y",storage:"disable_dimensions:config"}," ",{color:"aqua",nbt:"world_spawn.z",storage:"disable_dimensions:config"}," ",{color:"dark_green",text:"◎",click_event:{action:"run_command",command:"function disable_dimensions:config/set_world_spawn"},hover_event:{action:"show_text",value:["",{text:"Set "},{color:"gold",text:"World Spawn "},{color:"white",text:"to "},{color:"dark_green",text:"your current position"}]}}]
