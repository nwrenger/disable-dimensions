...
$execute unless data storage disable_dimensions:tmp {cur:{id:"$(id)"}} run data modify storage disable_dimensions:config dimensions append from storage disable_dimensions:tmp cur
