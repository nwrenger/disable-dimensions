...
execute unless data storage disable_dimensions:tmp {tp:{valid_respawn:true}} \
    run data modify storage disable_dimensions:tmp tp.path set value "disable_dimensions:end/teleport_sequence"
execute if data storage disable_dimensions:tmp {tp:{valid_respawn:true}} \
    run data modify storage disable_dimensions:tmp tp.path set value "disable_dimensions:end/teleport_sequence_area"
execute as @s \
