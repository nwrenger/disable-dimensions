...
execute if data storage disable_dimensions:tmp {tp:{bed_ok:true}} run data modify storage disable_dimensions:tmp tp.path set value "disable_dimensions:end/tp_area"
