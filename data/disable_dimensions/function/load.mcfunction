...
tellraw @a ["",{"text":"Disable Dimensions","bold":true,"color":"gold"},{"text":" by "},{"text":"nwrenger","italic":true,"color":"#F223F2","click_event":{"action":"open_url","url":"https://nwrenger.dev"}}," successfully installed\n"]
