...
execute as @a[tag=disable_dimensions_nether_tp] run function disable_dimensions:teleport/positioned with storage disable_dimensions:tmp tp
...
# Apply fx
execute as @a[tag=disable_dimensions_nether_tp] run function disable_dimensions:fx/arrival
