...
$tellraw @s [ \
    ...
    { \
        ...
        "hoverEvent": {"action": "show_text", "value": [{"color": "red", "translate": "disable_dimensions.config.dimension.hover.remove", "fallback": "Remove this entry"}]} \
    } \
]
...
$tellraw @s [ \
    ...
    { \
        ...
        "hoverEvent": {"action": "show_text", "value": [{"color": "gold", "translate": "disable_dimensions.config.dimension.message.hover.edit", "fallback": "Edit message text/color"}]} \
    } \
]
